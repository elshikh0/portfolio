...
import { DownloadButton } from './ui/LitUp'
        ...
        <div className="flex justify-center relative my-20 z-10">
            <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                ...
                <TextGenerateEffect 
                 ...
                 words = "Abdalla Elshikh. I build things for the web"
                />

                <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:texy-2xl">
                    A web developer who turns ideas into awesome, user-friendly websites. Let&apos;s create something cool together!
                </p>
