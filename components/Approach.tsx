    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
            ...
            description="Define goals, gather content, and align on timelines and budget."
            >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card 
            ...
            description="Develop the site with responsive design, and implement essential features."
            >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card 
            ...
            description="Test thoroughly, refine based on feedback, and launch with ongoing support."
            >
          <CanvasRevealEffect
            animationSpeed={3}
